...
azd_credential = InteractiveBrowserCredential(logging_enable=True) if args.tenantid == None else InteractiveBrowserCredential(tenant_id=args.tenantid, process_timeout=60)
